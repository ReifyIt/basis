...
trait StrictIndexOpsBehaviors extends StrictSeqOpsBehaviors { this: FunSpec =>
  import ShouldMatchers._
  
  def SequentialStrictIndexOps[CC[A] <: Index[A]](CC: BuilderFactory[CC]) {
    import CC.Builder
    import strict._
    
    describe(s"A strict $CC index") {
      ...
      it("should concatenate with another indexed sequence") {
