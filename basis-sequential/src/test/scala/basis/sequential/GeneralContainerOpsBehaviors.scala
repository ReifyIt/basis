...
trait GeneralContainerOpsBehaviors extends GeneralCollectionOpsBehaviors { this: FunSpec =>
  import ShouldMatchers._
  
  def SequentialGeneralContainerOps[CC[A] <: Container[A]](CC: BuilderFactory[CC]) {
    import general._
