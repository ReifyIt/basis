...
final class NonStrictMapOps[+A, +T](val these: Map[A, T]) extends AnyVal {
  ...
  /** Returns a view of all entries following the longest prefix of this
    * $collection for which each entry satisfies a predicate.
    * 
  ...
  /** Returns a view of all entries in this $collection following a prefix
    * up to some length.
    * 
  ...
  /** Returns a view of an interval of entries in this $collection.
    * 
