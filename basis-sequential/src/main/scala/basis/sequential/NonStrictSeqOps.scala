...
private[sequential] object NonStrictSeqOps {
  class Collect[-A, +B](
    ...
    extends NonStrictContainerOps.Collect[A, B](base, q) with Seq[B]
  
  class Map[-A, +B](
      protected[this] override val base: Seq[A],
      protected[this] override val f: A => B)
    extends NonStrictContainerOps.Map[A, B](base, f) with Seq[B]
  
  class FlatMap[-A, +B](
      protected[this] override val base: Seq[A],
      protected[this] override val f: A => Seq[B])
    extends NonStrictContainerOps.FlatMap[A, B](base, f) with Seq[B]
  
  class Filter[+A](
      protected[this] override val base: Seq[A],
      protected[this] override val p: A => Boolean)
    extends NonStrictContainerOps.Filter[A](base, p) with Seq[A]
  
  class DropWhile[+A](
      protected[this] override val base: Seq[A],
      protected[this] override val p: A => Boolean)
    extends NonStrictContainerOps.DropWhile[A](base, p) with Seq[A]
  
  class TakeWhile[+A](
      protected[this] override val base: Seq[A],
      protected[this] override val p: A => Boolean)
    extends NonStrictContainerOps.TakeWhile[A](base, p) with Seq[A]
  
  class Drop[+A](
      protected[this] override val base: Seq[A],
      protected[this] override val lower: Int)
    extends NonStrictContainerOps.Drop[A](base, lower) with Seq[A]
  
  class Take[+A](
      protected[this] override val base: Seq[A],
      protected[this] override val upper: Int)
    extends NonStrictContainerOps.Take[A](base, upper) with Seq[A]
  
  class Slice[+A](
      protected[this] override val base: Seq[A],
      protected[this] override val lower: Int,
      protected[this] override val upper: Int)
    extends NonStrictContainerOps.Slice[A](base, lower, upper) with Seq[A]
  
  class Zip[+A, +B](
      protected[this] override val xs: Seq[A],
      protected[this] override val ys: Seq[B])
    extends NonStrictContainerOps.Zip[A, B](xs, ys) with Seq[(A, B)]
  
  class ++[+A](
      protected[this] override val xs: Seq[A],
      protected[this] override val ys: Seq[A])
    extends NonStrictContainerOps.++[A](xs, ys) with Seq[A]
}
