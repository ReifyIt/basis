...
/** Strictly evaluated indexed sequence operations.
  ...
  */
abstract class StrictIndexedSeqOps[A, Family] private[sequential] {
  ...
  /** Returns the reverse of this sequence.
    ...
    * @group  Combining
    */
  def reverse[To](implicit builder: Builder[Family, A, To]): To =
  ...
  /** Returns pairs of elements from this and another sequence.
    ...
    * @group  Combining
    */
  def zip[B, To](that: IndexedSeq[B])(implicit builder: Builder[Family, (A, B), To]): To =
  ...
  /** Returns the concatenation of this and another sequence.
    ...
    * @group  Combining
    */
  def ++ [B >: A, To](that: IndexedSeq[B])(implicit builder: Builder[Family, B, To]): To =
...
private[sequential] object StrictIndexedSeqOps {
  ...
  private def IndexedSeqTag[A : c.WeakTypeTag](c: Context): c.WeakTypeTag[IndexedSeq[A]] = {
    ...
    import c.universe._
    WeakTypeTag(appliedType(mirror.staticClass("basis.collections.IndexedSeq").toType, weakTypeOf[A] :: Nil))
  }
}
