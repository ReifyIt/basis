...
/** General collection operations.
  ...
  */
class GeneralCollectionOps[A, From](val __ : Collection[A]) extends AnyVal {
  ...
  def fold[B >: A](z: B)(op: (B, B) => B): B =
    new GeneralEnumeratorOps[B, From](__).fold[B](z)(op) // FIXME: waiting on SI-6482
  ...
  def reduce[B >: A](op: (B, B) => B): B =
    new GeneralEnumeratorOps[B, From](__).reduce[B](op) // FIXME: waiting on SI-6482
  ...
  def reduceOption[B >: A](op: (B, B) => B): Option[B] =
    new GeneralEnumeratorOps[B, From](__).reduceOption[B](op) // FIXME: waiting on SI-6482
  ...
  def foldLeft[B](z: B)(op: (B, A) => B): B =
    new GeneralEnumeratorOps[A, From](__).foldLeft[B](z)(op)
  ...
  def reduceLeft[B >: A](op: (B, A) => B): B =
    new GeneralEnumeratorOps[B, From](__).reduceLeft[B](op.asInstanceOf[(B, B) => B]) // FIXME: waiting on SI-6482
  ...
  def reduceLeftOption[B >: A](op: (B, A) => B): Option[B] =
    new GeneralEnumeratorOps[B, From](__).reduceLeftOption[B](op.asInstanceOf[(B, B) => B]) // FIXME: waiting on SI-6482
  ...
  def find(p: A => Boolean): Option[A] =
    new GeneralEnumeratorOps[A, From](__).find(p)
  ...
  def forall(p: A => Boolean): Boolean =
    new GeneralEnumeratorOps[A, From](__).forall(p)
  ...
  def exists(p: A => Boolean): Boolean =
    new GeneralEnumeratorOps[A, From](__).exists(p)
  ...
  def count(p: A => Boolean): Int =
    new GeneralEnumeratorOps[A, From](__).count(p)
  ...
  def choose[B](q: PartialFunction[A, B]): Option[B] =
    new GeneralEnumeratorOps[A, From](__).choose[B](q)
