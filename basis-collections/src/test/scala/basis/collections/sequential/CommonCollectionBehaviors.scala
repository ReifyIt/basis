...
trait CommonCollectionBehaviors { this: FunSpec =>
  import common.CommonCollectionOps
  import ShouldMatchers._
  
  def GenericCommonCollection[CC[A] <: Collection[A]](CC: BuilderFactory[CC]) {
    describe(s"A common $CC collection") {
