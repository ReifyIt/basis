...
trait CommonContainerBehaviors extends CommonCollectionBehaviors { this: FunSpec =>
  import common.CommonContainerOps
  import ShouldMatchers._
  
  def GenericCommonContainer[CC[A] <: Container[A]](CC: BuilderFactory[CC]) {
