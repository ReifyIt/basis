...
trait GeneralLinearSeqBehaviors extends GeneralSeqBehaviors { this: FunSpec =>
  import general.GeneralLinearSeqOps
  import ShouldMatchers._
  
  def GenericGeneralLinearSeq[CC[A] <: LinearSeq[A]](CC: BuilderFactory[CC]) {
    describe(s"A general linear $CC sequence") {
