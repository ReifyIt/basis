...
trait CommonSetBehaviors extends CommonContainerBehaviors { this: FunSpec =>
  import common.CommonSetOps
  import ShouldMatchers._
  
  def GenericCommonSet[CC[A] <: Set[A]](CC: BuilderFactory[CC]) {
    describe(s"A common unique $CC") {
