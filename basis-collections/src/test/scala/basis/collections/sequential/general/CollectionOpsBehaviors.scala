...
trait CollectionOpsBehaviors { this: FunSpec =>
  import general.CollectionOps
  import ShouldMatchers._
  
  def SequentialGeneralCollectionOps[CC[A] <: Collection[A]](CC: generic.BuilderFactory[CC]) {
    describe(s"A general $CC collection") {
