...
trait LinearSeqOpsBehaviors extends SeqOpsBehaviors { this: FunSpec =>
  import general.LinearSeqOps
  import ShouldMatchers._
  
  def SequentialGeneralLinearSeqOps[CC[A] <: LinearSeq[A]](CC: generic.BuilderFactory[CC]) {
