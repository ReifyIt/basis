...
trait ContainerOpsBehaviors extends CollectionOpsBehaviors { this: FunSpec =>
  import general.ContainerOps
  import ShouldMatchers._
  
  def SequentialGeneralContainerOps[CC[A] <: Container[A]](CC: generic.BuilderFactory[CC]) {
