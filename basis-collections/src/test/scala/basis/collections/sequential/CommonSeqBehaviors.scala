...
trait CommonSeqBehaviors extends CommonContainerBehaviors { this: FunSpec =>
  import common.CommonSeqOps
  import ShouldMatchers._
  
  def GenericCommonSeq[CC[A] <: Seq[A]](CC: BuilderFactory[CC]) {
    describe(s"A common $CC sequence") {
