...
trait GeneralSetBehaviors extends GeneralContainerBehaviors { this: FunSpec =>
  import general.GeneralSetOps
  import ShouldMatchers._
  
  def GenericGeneralSet[CC[A] <: Set[A]](CC: BuilderFactory[CC]) {
    describe(s"A general unique $CC") {
