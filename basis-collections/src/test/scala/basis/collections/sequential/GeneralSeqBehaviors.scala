...
trait GeneralSeqBehaviors extends GeneralContainerBehaviors { this: FunSpec =>
  import general.GeneralSeqOps
  import ShouldMatchers._
  
  def GenericGeneralSeq[CC[A] <: Seq[A]](CC: BuilderFactory[CC]) {
    describe(s"A general $CC sequence") {
