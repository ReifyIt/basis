...
trait CommonLinearSeqBehaviors extends CommonSeqBehaviors { this: FunSpec =>
  import common.CommonLinearSeqOps
  import ShouldMatchers._
  
  def GenericCommonLinearSeq[CC[A] <: LinearSeq[A]](CC: BuilderFactory[CC]) {
    describe(s"A common linear $CC sequence") {
