...
trait SetOpsBehaviors extends ContainerOpsBehaviors { this: FunSpec =>
  import strict.SetOps
  import ShouldMatchers._
  
  def SequentialStrictSetOps[CC[A] <: Set[A]](CC: generic.BuilderFactory[CC]) {
    import CC.Builder
