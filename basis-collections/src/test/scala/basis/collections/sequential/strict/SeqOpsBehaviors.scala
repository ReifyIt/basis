...
trait SeqOpsBehaviors extends ContainerOpsBehaviors { this: FunSpec =>
  import strict.SeqOps
  import ShouldMatchers._
  
  def SequentialStrictSeqOps[CC[A] <: Seq[A]](CC: generic.BuilderFactory[CC]) {
    import CC.Builder
