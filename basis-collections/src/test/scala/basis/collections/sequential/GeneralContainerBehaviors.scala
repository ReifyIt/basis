...
trait GeneralContainerBehaviors extends GeneralCollectionBehaviors { this: FunSpec =>
  import general.GeneralContainerOps
  import ShouldMatchers._
  
  def GenericGeneralContainer[CC[A] <: Container[A]](CC: BuilderFactory[CC]) {
    describe(s"A general $CC container") {
