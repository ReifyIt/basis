...
trait GeneralIndexedSeqBehaviors extends GeneralSeqBehaviors { this: FunSpec =>
  import general.GeneralIndexedSeqOps
  import ShouldMatchers._
  
  def GenericGeneralIndexedSeq[CC[A] <: IndexedSeq[A]](CC: BuilderFactory[CC]) {
