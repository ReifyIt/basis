...
private[containers] final class ArrayBuilder[A](implicit A: scala.reflect.ClassTag[A]) extends Builder[Any, A] {
...
private[containers] final class ByteArrayBuilder
...
private[containers] final class ShortArrayBuilder
...
private[containers] final class IntArrayBuilder
...
private[containers] final class LongArrayBuilder
...
private[containers] final class FloatArrayBuilder
...
private[containers] final class DoubleArrayBuilder
