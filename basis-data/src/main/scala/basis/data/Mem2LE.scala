...
class Mem2LE(val words: Array[Short]) extends AnyVal with MemLE {
  ...
  override def toString: String = "Mem2LE"+"("+ size +")"
}
...
object Mem2LE extends Allocator with (Long => Mem2LE) {
  ...
  def unapply(mem: Mem2LE): Some[Array[Short]] = Some(mem.words)
  
  override def toString: String = "Mem2LE"
}
