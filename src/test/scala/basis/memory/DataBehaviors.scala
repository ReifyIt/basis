...
trait DataBehaviors extends ValueTypeBehaviors { this: FunSpec =>
  ...
  def PrimitiveData(implicit allocator: Allocator) {
    ...
    it("should store aligned Char values") {
      val data = Data.alloc[Char](1L)
      data.storeChar(0L, 0xF7F6.toChar)
      data.loadChar(0L).toShort should equalShort (0xF7F6.toShort)
    }
    
    it("should store unaligned Char values") {
      val data = Data.alloc[Char](2L)
      data.storeUnalignedChar(1L, 0xF7F6.toChar)
      data.loadUnalignedChar(1L).toShort should equalShort (0xF7F6.toShort)
    }
    
    it("should truncate unaligned addresses of aligned Char values") {
      val data = Data.alloc[Char](2L)
      data.storeChar(1L, 0xF7F6.toChar)
      withClue("unaligned address") (data.loadChar(1L).toShort should equalShort (0xF7F6.toShort))
      withClue("truncated address") (data.loadChar(0L).toShort should equalShort (0xF7F6.toShort))
    }
    
    it("should store sequential Char values") {
      val data = Data.alloc[Char](3L)
      data.storeChar(0L, 0xF7F6.toChar)
      data.storeChar(2L, 0xE7E6.toChar)
      data.storeChar(4L, 0xD7D6.toChar)
      withClue("1st value") (data.loadChar(0L).toShort should equalShort (0xF7F6.toShort))
      withClue("2nd value") (data.loadChar(2L).toShort should equalShort (0xE7E6.toShort))
      withClue("3rd value") (data.loadChar(4L).toShort should equalShort (0xD7D6.toShort))
    }
  ...
  def LittleEndianData(implicit allocator: Allocator) {
    ...
    it("should store little-endian aligned Char values") {
      val data = Data.alloc[Char](1L)
      data.storeChar(0L, 0xF7F6.toChar)
      withClue("byte 0:") (data.loadByte(0L) should equalByte (0xF6.toByte))
      withClue("byte 1:") (data.loadByte(1L) should equalByte (0xF7.toByte))
    ...
    it("should store little-endian unaligned Char values") {
      val data = Data.alloc[Char](1L)
      data.storeUnalignedChar(0L, 0xF7F6.toChar)
      withClue("byte 0:") (data.loadByte(0L) should equalByte (0xF6.toByte))
      withClue("byte 1:") (data.loadByte(1L) should equalByte (0xF7.toByte))
