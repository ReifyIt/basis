...
/** A 2 by 2 real matrix space.
  ...
  * @author Chris Sachs
  */
object R2x2 extends F2x2[R2.type, Binary64.type] with RMxN[R2.type, R2.type] {
  final class Element(
    ...
    override def det(implicit isSquare: R2.type =:= R2.type): Scalar =
      _1_1 * _2_2 - _1_2 * _2_1
    
    override def trace(implicit isSquare: R2.type =:= R2.type): Scalar = _1_1 + _2_2
  }
