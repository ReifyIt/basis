...
final class Data4BE(final val words: Array[Int]) extends AnyVal with DataBE {
  ...
  final override def copy(size: Long = this.size): Data4BE = {
...
object Data4BE extends Allocator with (Long => Data4BE) {
  ...
  def unapply(data: Data4BE): Some[Array[Int]] = Some(data.words)
