...
trait Matrix4x4 extends Any with MatrixRing { self =>
  ...
  def row1: Row = Matrix.Row(_1_1, _1_2, _1_3, _1_4)
  def row2: Row = Matrix.Row(_2_1, _2_2, _2_3, _2_4)
  def row3: Row = Matrix.Row(_3_1, _3_2, _3_3, _3_4)
  def row4: Row = Matrix.Row(_4_1, _4_2, _4_3, _4_4)
  ...
  def col1: Col = Matrix.Col(_1_1, _2_1, _3_1, _4_1)
  def col2: Col = Matrix.Col(_1_2, _2_2, _3_2, _4_2)
  def col3: Col = Matrix.Col(_1_3, _2_3, _3_3, _4_3)
  def col4: Col = Matrix.Col(_1_4, _2_4, _3_4, _4_4)
  ...
  override def :⋅ (vector: Row): Col =
    Matrix.Col(_1_1 * vector.x + _1_2 * vector.y + _1_3 * vector.z + _1_4 * vector.w,
  ...
  override def ⋅: (vector: Col): Row =
    Matrix.Row(vector.x * _1_1 + vector.y * _2_1 + vector.z * _3_1 + vector.w * _4_1,
