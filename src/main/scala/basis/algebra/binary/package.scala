...
package object binary {
  /** Returns the closest Double value to `a * b^n` */
  private[algebra] def mkDouble(a: Long, b: Int, n: Int): Double = {
    if (a == 0L) 0.0
  ...
  /** Returns the closest Long value to `a * b^n` */
  private[algebra] def mkLong(a: Double, b: Int, n: Int): Long = {
  ...
  /** Returns the `a * 2^n` closest to `a * b^n` */
  private[algebra] def base2(a: Long, b: Int, n: Int): (Long, Int) = {
    if (a == 0L) (0L, 0)
