...
object R2x2 extends Matrix2x2Space[R2.type, R2.type, Real.type] with RealMatrixSpace[R2.type, R2.type] {
  final class Element(
      val _1_1: Real, val _1_2: Real,
      val _2_1: Real, val _2_2: Real)
    extends super[Matrix2x2Space].Element
    ...
    override def row1: Row = new R2.Vector(_1_1, _1_2)
    override def row2: Row = new R2.Vector(_2_1, _2_2)
    ...
    override def col1: Col = new R2.Vector(_1_1, _2_1)
    override def col2: Col = new R2.Vector(_1_2, _2_2)
