...
object VectorR2 {
  ...
  /** The inner product typeclass for `R2`. */
  implicit val innerProduct = InnerProduct[VectorR2, Real](_ ⋅ _)
  
  /** The norm typeclass for `R2`. */
  implicit val norm = Norm[VectorR2, Real](_.norm)
