...
trait MatrixR4x4[M <: MatrixR4x4[M, V], V <: VectorR4[V]]
  ...
  override def column1: V = Space.Column(this( 0), this( 4), this( 8), this(12))
  
  override def column2: V = Space.Column(this( 1), this( 5), this( 9), this(13))
  
  override def column3: V = Space.Column(this( 2), this( 6), this(10), this(14))
  
  override def column4: V = Space.Column(this( 3), this( 7), this(11), this(15))
  
  override def row1: V = Space.Row(this( 0), this( 1), this( 2), this( 3))
  
  override def row2: V = Space.Row(this( 4), this( 5), this( 6), this( 7))
  
  override def row3: V = Space.Row(this( 8), this( 9), this(10), this(11))
  
  override def row4: V = Space.Row(this(12), this(13), this(14), this(15))
