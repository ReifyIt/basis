...
trait MatrixF4x4 extends MatrixFMxN { self =>
  ...
  def row1: RowVector = Space.Row(entry( 0), entry( 1), entry( 2), entry( 3))
  
  def row2: RowVector = Space.Row(entry( 4), entry( 5), entry( 6), entry( 7))
  
  def row3: RowVector = Space.Row(entry( 8), entry( 9), entry(10), entry(11))
  
  def row4: RowVector = Space.Row(entry(12), entry(13), entry(14), entry(15))
  
  def column1: ColumnVector = Space.Column(entry( 0), entry( 4), entry( 8), entry(12))
  
  def column2: ColumnVector = Space.Column(entry( 1), entry( 5), entry( 9), entry(13))
  
  def column3: ColumnVector = Space.Column(entry( 2), entry( 6), entry(10), entry(14))
  
  def column4: ColumnVector = Space.Column(entry( 3), entry( 7), entry(11), entry(15))
