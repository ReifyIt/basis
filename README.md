...
- \[[API](http://basis.reify.it/latest/api/#basis.generators.package)\] [basis.generators](http://basis.reify.it/generators.html) – Arbitrary data generation  
`"it.reify" %% "basis-generators" % "0.1-SNAPSHOT"`
...
- \[[API](http://basis.reify.it/latest/api/#basis.control.package)\] [basis.control](http://basis.reify.it/control.html) – Control-flow utilities  
