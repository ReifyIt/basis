...
class Data8(val words: Array[Long]) extends AnyVal with Data {
  ...
  override def copy(size: Long = this.size): Data8 = {
  ...
  def toBE: Data8BE = new Data8BE(words)
  
  def toLE: Data8LE = new Data8LE(words)
