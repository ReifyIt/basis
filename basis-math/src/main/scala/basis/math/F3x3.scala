...
trait F3x3 extends Ring with FMxN {
  trait Value extends Any with super[Ring].Value with super[FMxN].Value {
    ...
    override def Col: F3x3.this.Col.type = F3x3.this.Col
  ...
  override val Transpose: F3x3 {
    val Row: F3x3.this.Col.type
    val Col: F3x3.this.Row.type
    val Scalar: F3x3.this.Scalar.type
  }
  
  override val Row: F3 { val Scalar: F3x3.this.Scalar.type }
  override val Col: F3 { val Scalar: F3x3.this.Scalar.type }
