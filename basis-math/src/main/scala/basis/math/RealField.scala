...
/** A complete, totally ordered abstract field structure. Addition associates
  ...
  * def testRealFieldOperations[R <: RealField with Singleton](a: R#Element, b: R#Element, c: R#Element) {
  ...
  * def testRealFieldIdentities(R: RealField)(a: R.Element, b: R.Element) {
  *   import R._
...
trait RealField extends OrderedField with CompleteField {
  trait Value extends Any with super[OrderedField].Value with super[CompleteField].Value {
