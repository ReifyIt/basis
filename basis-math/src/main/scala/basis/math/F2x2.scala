...
trait F2x2 extends Ring with FMxN {
  trait Value extends Any with super[Ring].Value with super[FMxN].Value {
    ...
    override def Col: F2x2.this.Col.type = F2x2.this.Col
  ...
  override val Transpose: F2x2 {
    val Row: F2x2.this.Col.type
    val Col: F2x2.this.Row.type
    val Scalar: F2x2.this.Scalar.type
  }
  
  override val Row: F2 { val Scalar: F2x2.this.Scalar.type }
  override val Col: F2 { val Scalar: F2x2.this.Scalar.type }
