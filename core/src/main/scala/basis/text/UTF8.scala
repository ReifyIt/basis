...
object UTF8 {
  /** Returns a new string builder that appends UTF-8-encoded code points to a byte array. */
  def Encoder: StringBuilder with State[Array[Byte]] = new UTF8ArrayEncoder

  /** Returns a new builder that composes UTF-8 code units into valid Unicode code points. */
  def Decoder(self: StringBuilder): Builder[Int] with State[self.State] = new UTF8Decoder[self.State](self)

  override def toString: String = "UTF8"
}

private[text] abstract class UTF8Encoder extends StringBuilder {
  ...
  protected def alias: Array[Byte] = {
...
private[text] final class UTF8ArrayEncoder extends UTF8Encoder with State[Array[Byte]] {
  override def state: Array[Byte] = alias

  override def toString: String = "UTF8"+"."+"Encoder"
}

private[text] final class UTF8Decoder[+Result](self: StringBuilder with State[Result]) extends Builder[Int] with State[Result] {
  ...
  override def toString: String = "UTF8"+"."+"Decoder"+"("+ self +")"
}
