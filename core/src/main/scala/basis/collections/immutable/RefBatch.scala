...
private[collections] final class RefBatch1[+A](_1: A) extends Batch[A] {
  ...
  override def :+ [B >: A](elem: B): Batch[B] = new RefBatch2(_1, elem)

  override def +: [B >: A](elem: B): Batch[B] = new RefBatch2(elem, _1)

  override def traverse(f: A => Unit): Unit = {
    f(_1)
  }

  override def flatTraverse[B](f: B => Unit)(implicit isNested: A <:< Batch[B]): Unit = {
    _1.traverse(f)
  }
}

private[collections] final class RefBatch2[+A](_1: A, _2: A) extends Batch[A] {
  override def isEmpty: Boolean = false
  ...
  override def :+ [B >: A](elem: B): Batch[B] = new RefBatch3(_1, _2, elem)

  override def +: [B >: A](elem: B): Batch[B] = new RefBatch3(elem, _1, _2)
...
private[collections] final class RefBatch3[+A](_1: A, _2: A, _3: A) extends Batch[A] {
  override def isEmpty: Boolean = false
  ...
  override def :+ [B >: A](elem: B): Batch[B] = new RefBatch4(_1, _2, _3, elem)

  override def +: [B >: A](elem: B): Batch[B] = new RefBatch4(elem, _1, _2, _3)
...
private[collections] final class RefBatch4[+A]
    (_1: A, _2: A, _3: A, _4: A)
  extends Batch[A] {
  ...
  override def :+ [B >: A](elem: B): Batch[B] = new RefBatch5(_1, _2, _3, _4, elem)

  override def +: [B >: A](elem: B): Batch[B] = new RefBatch5(elem, _1, _2, _3, _4)
...
private[collections] final class RefBatch5[+A]
...
private[collections] final class RefBatch6[+A]
...
private[collections] final class RefBatchN[+A]
